...
public class Stage3 {
	 ...
	 */
	public int removeDigit(int n, int loc) {
	 ...
	 */
	public boolean sameFirstDigit(int a, int b) {
		return false;
	}
	 ...
	 */
	public int withoutFirstDigit(int n) {
		return 0; //to be completed
	}
	 ...
	 */
	public int highestNumber(int n) {
		return 0; //to be completed
	}
	 ...
	 */
	public int smallestEvenNumber(int n) {
		return 0; //to be completed
	}
...
//	public boolean biggestEvenNumber(int n) {
//		
//	}
