...
public class Stage1 {
	 ...
	 */
	public Integer getLastItem(ArrayList<Integer> list) {
		return null;
	}
	 ...
	 */
	public Integer getSumFirstLastItems(ArrayList<Integer> list) {
	 ...
	 */
	public boolean containsEvenNumberOfItems(ArrayList<Integer> list) {
		return false;
	}
	 ...
	 */
	public boolean sameSize(ArrayList<Integer> a, ArrayList<Integer> b) {
	 ...
	 * 
	 */
	public Integer median(ArrayList<Integer> list) {
		return null; //to be completed
	}
	 ...
	 * return null if list is null or empty
	 */
	public Rectangle getFirstItem(ArrayList<Rectangle> list) {
		return null; //to be completed
	}
}
