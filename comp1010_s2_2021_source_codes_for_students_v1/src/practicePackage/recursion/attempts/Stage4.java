...
public class Stage4 {
	 ...
	 */
	public Integer inverseModule(int a, int n) {
		return 0; //to be completed
	}
	 ...
	 * TEST NOT PROVIDED
	 */
	public int longestAscendingSubsequence(int[] data) {
		return 0;
	}
	 ...
	 * TEST NOT PROVIDED
	 */
	public int longestDescendingSubsequence(int[] data) {
		return 0;
	}
}
