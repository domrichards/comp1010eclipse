...
public class Stage3Test {
	...
	public void testRemoveDigit() {
		assertEquals(1729, testObject.removeDigit(1729, -1));
		assertEquals(1729, testObject.removeDigit(1729, 0));
		assertEquals(1729, testObject.removeDigit(1729, 5));
		assertEquals(172, testObject.removeDigit(1729, 1));
		assertEquals(729, testObject.removeDigit(1729, 4));
		assertEquals(179, testObject.removeDigit(1729, 2));
		assertEquals(129, testObject.removeDigit(1729, 3));
		assertEquals(2, testObject.removeDigit(1002, 4));
		assertEquals(-94825, testObject.removeDigit(-94825,-1));
		assertEquals(-94825, testObject.removeDigit(-94825,0));
		assertEquals(-94825, testObject.removeDigit(-94825,6));
		assertEquals(-4825, testObject.removeDigit(-94825,5));
	}
	...
	public void testSameFirstDigit() {
		assertTrue(testObject.sameFirstDigit(5, 5));
		assertTrue(testObject.sameFirstDigit(5, -5));
		assertTrue(testObject.sameFirstDigit(-5, 5));
		assertTrue(testObject.sameFirstDigit(-5, -5));
		assertTrue(testObject.sameFirstDigit(0, 0));
		assertTrue(testObject.sameFirstDigit(25, 28));
		assertTrue(testObject.sameFirstDigit(-235, 28));
		assertTrue(testObject.sameFirstDigit(25, -2813));
		assertTrue(testObject.sameFirstDigit(-6325, 625458));
		assertFalse(testObject.sameFirstDigit(5, 6));
		assertFalse(testObject.sameFirstDigit(-5, 6));
		assertFalse(testObject.sameFirstDigit(5, -6));
		assertFalse(testObject.sameFirstDigit(-5, -6));
		assertFalse(testObject.sameFirstDigit(25, 35));
		assertFalse(testObject.sameFirstDigit(21325, 35122));
		assertFalse(testObject.sameFirstDigit(91322335, 45535122));
	}
	...
	public void testWithoutFirstDigit() {
		assertEquals(234567, testObject.withoutFirstDigit(1234567));
		assertEquals(34567, testObject.withoutFirstDigit(234567));
		assertEquals(4567, testObject.withoutFirstDigit(34567));
		assertEquals(567, testObject.withoutFirstDigit(4567));
		assertEquals(67, testObject.withoutFirstDigit(567));
		assertEquals(7, testObject.withoutFirstDigit(67));
		assertEquals(0, testObject.withoutFirstDigit(7));
		assertEquals(-234567, testObject.withoutFirstDigit(-1234567));
		assertEquals(-34567, testObject.withoutFirstDigit(-234567));
		assertEquals(-4567, testObject.withoutFirstDigit(-34567));
		assertEquals(-567, testObject.withoutFirstDigit(-4567));
	...
	public void testHighestNumber() {
		assertEquals(2100, testObject.highestNumber(1002));
		assertEquals(9721, testObject.highestNumber(1729));
		assertEquals(876543210, testObject.highestNumber(102764583));
		assertEquals(0, testObject.highestNumber(0));
		assertEquals(10000, testObject.highestNumber(10000));
	}
	
	@Test
	public void testSmallestNumber() {
		assertEquals(12, testObject.smallestNumber(1002));
		assertEquals(1279, testObject.smallestNumber(1729));
		assertEquals(12345678, testObject.smallestNumber(102764583));
		assertEquals(0, testObject.smallestNumber(0));
		assertEquals(1, testObject.smallestNumber(10000));
	}
	
	@Test
	public void testSmallestEvenNumber() {
		assertEquals(12, testObject.smallestEvenNumber(1002));
		assertEquals(1792, testObject.smallestEvenNumber(1729));
		assertEquals(12345678, testObject.smallestEvenNumber(102764583));
		assertEquals(124796, testObject.smallestEvenNumber(147692));
		assertEquals(0, testObject.smallestEvenNumber(0));
		assertEquals(10, testObject.smallestEvenNumber(10000));
	}
