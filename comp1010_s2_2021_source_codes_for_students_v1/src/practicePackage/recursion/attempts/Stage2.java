...
public class Stage2 {
	 ...
	 */
	public int smallestEvenDigit(int n) {
		return 0;	
	}
	 ...
	 * return 0 if the number doesn't have any even digits
	 */
	public int highestEvenDigit(int n) {
		return 0;	
	}
	 ...
	 * return 0 if the number doesn't have any even digits
	 */
	public int highestEvenDigitLocation(int n) {
		return 0;
	}
	 ...
	 * return 0 if the number doesn't have any even digits
	 */
	public int highestDigitLocation(int n) {
		return 0;
	}
	 ...
	 * return 0 if the number doesn't have any even digits
	 */
	public int smallestDigitLocation(int n) {
		return 0;
	}
}
