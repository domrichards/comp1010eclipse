...
public class Stage4 {
	 ...
	 */
	public void sort(ArrayList<Integer> list, boolean asc) {
		//to be completed
	}
	 ...
	 */
	public ArrayList<Integer> getLongestAscendingRun(ArrayList<Integer> list) {
		return null; //to be completed
	}
	 ...
	 */
	public boolean nInARow(ArrayList<Integer> list, int target, int n) {
	 ...
	 */
	public ArrayList<Integer> getIntersection(ArrayList<Integer> a, ArrayList<Integer> b) {
		return null; //to be completed
	}
	 ...
	 * return null if either list is null
	 */
	public ArrayList<Integer> getIntersectionV2(ArrayList<Integer> a, ArrayList<Integer> b) {
		return null; //to be completed
	}

	public int count(ArrayList<Integer> list, int temp) {
		int c = 0;
	 ...
	 */
	public ArrayList<Integer> itemsInAtleastN(ArrayList<ArrayList<Integer>> list, int n) {
		return null; //to be completed
	}
	 ...
	 */
	public ArrayList<Integer> productAllButOne(ArrayList<Integer> list) {
		return null; //to be completed
	}
	 ...
	 * if list = {}, return {}
	 */
	public ArrayList<Integer> getLongestAscendingSequence(ArrayList<Integer> list) {
		return null; //to be completed
	}
	 ...
	 * if list = {}, return {}
	 */
	public ArrayList<Integer> getLongestDescendingSequence(ArrayList<Integer> list) {
		return null; //to be completed
	}
	 ...
	 * if list = {}, return {}
	 */
	public ArrayList<Integer> getLongestUnchangedSequence(ArrayList<Integer> list) {
		return null; //to be completed
	}
	 ...
	 */
	public void sortAsc(ArrayList<Integer> list) {
		//to be completed
	}
	 ...
	 * do nothing if the list is null or has fewer than 2 items
	 */
	public void sortDesc(ArrayList<Integer> list) {
		//to be completed
	}
	 ...
	 */
	public void sortIfNeeded(ArrayList<Integer> list, boolean asc) {
		//to be completed
	}
	 ...
	 */
	public ArrayList<Integer> getCommonItemsSorted(ArrayList<Integer> a, ArrayList<Integer> b) {
		return null; //to be completed
	}
	 ...
	 */
	public ArrayList<Integer> getCommonItemsUnsorted(ArrayList<Integer> a, ArrayList<Integer> b) {
		return null; //to be completed
	}
	 ...
	 */
	public boolean noCommonItems(ArrayList<ArrayList<Integer>> list) {
		return false; //to be completed
	}
	 ...
	 * return the list {6,7}
	 */
	public ArrayList<Integer> longestMirroredSequence(ArrayList<Integer> list) {
		return null; //to be completed
	}
	 ...
	 */
	public ArrayList<Integer> getSet(ArrayList<Integer> list) {
		return null; //to be completed
	}
	 ...
	 */
	public ArrayList<ArrayList<Integer>> bestTotalSubLists(ArrayList<Integer> data, int n) {
		return null; //to be completed
	}
	 ...
	 */
	public ArrayList<Integer> getAllItemsFrom(ArrayList<Integer> data, ArrayList<Integer> unique) {
