...
public class Stage3Test {
	...
	public void testItemRemovedNeighbourhood() {
		assertNull(testObject.itemRemovedNeighbourhood(null, 0));
		int[] data = {10,70,70,70,20,90,70};

		int[] result = testObject.itemRemovedNeighbourhood(data, -1);
		assertEquals("[10, 70, 70, 70, 20, 90, 70]", Arrays.toString(result));
		assertNotEquals(data, result); //we want instance copy

		result = testObject.itemRemovedNeighbourhood(data, data.length);
		assertEquals("[10, 70, 70, 70, 20, 90, 70]", Arrays.toString(result));
		assertNotEquals(data, result); //we want instance copy

		result = testObject.itemRemovedNeighbourhood(data, 2);
